...
if __name__ == '__main__':
    ...
    delta = 0.55
    t_lowest, rectangles_lowest, x_lowest, y_lowest, v_lowest = [], [], [], [], []
    ...
    x_spiral, y_spiral = get_spiral(k, 16)

    theta_collision, rectangles_collision, x_collision, y_collision, v_collision = get_collision_by_theta(30, v0, k, d, d_prime, num, round_num)
    ...
    #
    #     theta0_collision, rectangles_collision, x_collision, y_collision, v_collision = get_collision_by_theta(30, v0, k, d, d_prime, num, round_num)
    #
    #     fig, ax = plt.subplots()
    #     ax.plot(x_spiral, y_spiral, linewidth=1)
    #     ax.scatter(x_collision, y_collision, s=1, color='green')
    ...
    #         t_lowest, rectangle_lowest, x_lowest, y_lowest, v_lowest = t_collision, rectangles_collision, x_collision, y_collision, v_collision
    #         break
    #
    # fig, ax = plt.subplots()
    # ax.plot(x_spiral, y_spiral, linewidth=1)
